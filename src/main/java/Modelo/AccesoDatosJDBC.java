...
public class AccesoDatosJDBC {
    ...
    private static final String SQL_INSERT = "INSERT INTO tb_favoritos (usuario, pokemon_id) VALUES(?, ?)";
    private static final String SQL_DELETE = "DELETE FROM tb_favoritos  WHERE pokemon_id = ?";
